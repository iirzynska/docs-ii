...
[source,terminal]
!wget https://raw.githubusercontent.com/iirzynska/multicloud-gitops-ii/intel-rhods-amx/scripts/BERT.ipynb -O BERT.ipynb

// change later for proper link something like:
// !wget https://raw.githubusercontent.com/validatedpatterns-sandbox/amx-accelerated-rhoai-multicloud-gitops/scripts/BERT.ipynb -O BERT.ipynb
