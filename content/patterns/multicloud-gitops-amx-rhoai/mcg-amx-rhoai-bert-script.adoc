...
== Introduction
The {amx-rhoai-mcg-pattern} provides developers and data scientists with {rhoai} thats fully configured and ready to go. It also helps accelerate their workloads through the integration of AMX, providing efficiency and performance optimization for AI workloads.
