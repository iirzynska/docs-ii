...
image::multicloud-gitops-amx-rhoai/schema-gitops.png[Physical Architecture]
...
image::multicloud-gitops-amx-rhoai/spi-multi-cloud-gitops-sd-install.png[Schematic diagram of bootstrapping the management hub]
...
image::multicloud-gitops-amx-rhoai/spi-multi-cloud-gitops-sd-security.png[Schematic diagram of hybrid multi-cloud management with GitOps]
...
image::multicloud-gitops-amx-rhoai/spi-multi-cloud-gitops-sd-security.png[Schematic showing the setup and use of external secrets management]
