...
weight: 10
aliases: /multicloud-gitops-rhods-amx/mcg-rhods-amx-getting-started/
---
 ...
 ** link:../../multicloud-gitops-rhods-amx/mcg-rhods-amx-cluster-sizing[Cluster sizing] requirements.
